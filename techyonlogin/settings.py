"""
Django settings for techyonlogin project.
...
assert environment in ["STAGE", "PROD"], "Unsupported Environment Provided choices are [STAGE, PROD]..."
...
ROOT_URLCONF = 'techyonlogin.urls'
...
WSGI_APPLICATION = 'techyonlogin.wsgi.application'
